...
import { UtensilsCrossed, House, Star, CreditCard, X, CheckCircle2 } from "lucide-react";
...
export default function CustomerLayout({
  ...
  const handleRequestBill = async () => {
    ...
    if (result.success) {
      ...
      // If result.error is "لا يمكنك طلب الحساب حتى يتم تقديم جميع الطلبات", we can show it nicely
      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-xl border-b border-slate-200/60 transition-all duration-300">
        <div className="mx-auto max-w-3xl px-6 py-4 flex items-center justify-between">
          ...
          <div className="text-right">
            <h1 className="text-xl font-black text-slate-900">مطعم النخبة</h1>
